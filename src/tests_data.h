/*
 * The tests array as been taken from the py-bcrypt project (python wrapper
 * around bcrypt) from Damien Miller <djm@mindrot.org>.
 *
 * Project page: 
 *  http://www.mindrot.org/projects/py-bcrypt/
 * Tests file:
 *  http://anoncvs.mindrot.org/index.cgi/py-bcrypt/test/test.py?view=markup
 *
